package id.antasari.p6minda_230104040222.ui.navigation
...
// ONBOARDING
import id.antasari.p6minda_230104040222.ui.WelcomeScreen
import id.antasari.p6minda_230104040222.ui.AskNameScreen
import id.antasari.p6minda_230104040222.ui.HelloScreen
import id.antasari.p6minda_230104040222.ui.StartJournalingScreen

// MAIN
import id.antasari.p6minda_230104040222.ui.HomeScreen
import id.antasari.p6minda_230104040222.ui.calendar.CalendarScreen
import id.antasari.p6minda_230104040222.ui.InsightsScreen
import id.antasari.p6minda_230104040222.ui.SettingsScreen
import id.antasari.p6minda_230104040222.ui.NewEntryScreen
import id.antasari.p6minda_230104040222.ui.NoteDetailScreen
import id.antasari.p6minda_230104040222.ui.EditEntryScreen
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(Routes.SETTINGS) {
            SettingsScreen(userName = storedName ?: "")
        }
        ...
        composable(
            ...
            val id = back.arguments?.getInt("entryId") ?: -1
            NoteDetailScreen(
                entryId = id,
                onBack = { navController.popBackStack() },
                onDeleted = {
